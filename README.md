...
The mod essentially enables the accumulation of wealth securely over time and across deaths, not only allowing players with enough saved up moeny to obtain equipment from traders more quickly without having to spend hours searching for it around the map, but also making it possible for server owners to add higher tiered, more expensive items to traders which wouldn't be feasable without some sort of meta progression.
